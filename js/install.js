...
function installExtension() {
    if (window.chrome) {
        ...
        var xpi = {
            DocentEDU: {
                URL: 'https://addons.mozilla.org/firefox/downloads/latest/docentedu/addon-579384-latest.xpi?src=external-signup',
...
function showBookmarklet() {
    var f = function(doc) {
        ...
        s.src = 'https://insertlearning.com/v1/toolbar/docent.js?t=' + t;
        s.async = true;
